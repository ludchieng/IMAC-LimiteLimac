...
**Contributors**: Ludwig Chieng, Daphné Chamot-Rooke, Théo Gautier, Alexandre Escudero, Fabian Adam

Web adaptation of the famous *Cards against humanity* game with REST API architecture. A short web project made for programming courses. :mortar_board:
